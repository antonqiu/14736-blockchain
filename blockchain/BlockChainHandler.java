...
public class BlockChainHandler implements BlockChainBase {
    ...
    public byte[] getBlockchainData() {
        return ObjectSerializer.serialize(this.blockChain);
    }
    ...
    public byte[] createNewBlock(String data) {
        ...
        newMinedBlockBytes = ObjectSerializer.serialize(newMinedBlock);
